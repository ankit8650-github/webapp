        ...
        <div className='container-fluid mt-2'>
            <div className='row'>
                <div className='col-md-6 col-12'>
                    <div className='background text-light text-center p-1 mb-1'>ankitbhardwaj865037@gmail.com</div>
                    <div className='background text-light text-center p-1 mb-1'>8650370233</div>
                    <div className='background text-light text-center p-1 mb-1'>Noida</div>
                </div>
                <div className='col-md-6 col-12'>
